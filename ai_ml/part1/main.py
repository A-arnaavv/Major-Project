...
from ai_ml.part1.rag.milvus_store import insert_documents

from ai_ml.part1.interview.question_generator import generate_interview_questions
...
def process_resume():
    ...
    pdf_path = str(DEFAULT_RESUME_PATH)
